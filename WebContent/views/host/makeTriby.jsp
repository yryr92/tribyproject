...
<style>
	...
	#contentImgArea1:hover, #contentImgArea2:hover, #contentImgArea3:hover, .btn:hover, .cate:hover{cursor:pointer;}
	table tr td{text-align:center;}
	#summernote{resize:none; width:100%; height:100%;}
...
<body>
	...
	<div id="wrap">
	<div id="title">트리비 만들기</div>
	<div id="content" class="jumbotron">
		<form method="post" action="<%= contextPath%>/insert.tr" enctype="multipart/form-data">
		<input type="hidden" name="loginHostno" value="<%= loginHost.getHost_no() %>">
		<div><input class="form-control form-control-lg" type="text" name="title" placeholder="트리비 제목을 입력하세요" id="inputLarge" required></div><br>
		<div id="editor">
			<textarea id="summernote" name="tribyContent" required>Try new Hobby!</textarea>
		</div> <br>
		<div id="plus">
		<table align="center">
				<tr>
				<td width="100px">썸네일 이미지</td>
					<td>
						<div id="contentImgArea1">
							<img id="contentImg1" width="240" height="120">
						</div>
					</td>
				...
				<td colspan="3"><input type="text" class="form-control" name="content1" required></td>
				</tr>
				<tr>
				<td height="50px">세부 일정</td>
				<td colspan="3"><input type="text" class="form-control" name="content2" required></td>
				</tr>
				<tr>
				<td height="50px">준비물</td>
				<td colspan="3"><input type="text" class="form-control" name="content3" required></td>
				</tr>
				<tr>
				<td height="50px">진행 장소</td>
				<td colspan="3"><input type="text" class="form-control" name="address" required></td>
				</tr>
				<tr>
				<td height="50px">가격</td>
				<td colspan="3"><input type="number" id="price" name="price" min="0" value="0" step="10000"></td>
				</tr>
				<tr>
...
<script>
		...
		$(function(){
			...
			$("input[name^=cate]:checkbox").change(function() {
				...
				if(limit==$("input[name^=cate]:checkbox:checked").length) {
