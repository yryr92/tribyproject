   	...
   	<%@ include file = "../common/header.jsp" %>
    	...
    	$(function(){
     		...
     		$("#findId").click(function(){
    			...
    			//var target = '<%=contextPath%>/views/member/findHoIDview.jsp'
    			//var view = window.open('about:blank','뷰', settings);
    			
    			$.ajax({
    				
    				url:"findId.ho", // FindMemberIDServlet
    				type:"post",
    				dataType:"json",
    				...
    				success:function(result){
    					if(name.val() == "" && phone.val() ==""){
							...
							if(result.status == "fail"){
        						...
        						//result.findID
        						window.open('<%=contextPath%>/views/host/findHoIDview.jsp?findIdHost='+result.findIdHost,'뷰', 'toolbar=0,status=0,menubar=0,height=230,width=430');
