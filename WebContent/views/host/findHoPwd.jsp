<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" %>
   <%
	String failHopwd = (String)request.getAttribute("failHopwd");
   %> 
<!DOCTYPE html>
<html>
<head>
...
<script>
	var failHopwd = "<%=failHopwd %>";
	
	$(function(){
	
		if(failHopwd != "null"){
			console.log(failHopwd);
			alert(failHopwd);
		}
...
<body>
  ...
  <form action="<%=contextPath %>/findPwd.ho" method="POST" id="userfid">
...
function findId(){
	...
	location.href = "<%=request.getContextPath()%>/findidhost.ho";
}
