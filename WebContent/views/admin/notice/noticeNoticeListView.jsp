        ...
        <div class="body">
            ...
            <div class="contentWrap">
                ...
                <div class="pagingArea" align="center">
                	<button onclick="location.href='<%=request.getContextPath()%>/notice.ad?selected=공지&currentPage=1';">&lt;&lt;</button>
                	<%if(currentPage ==1) { %>
                		<button disabled>&lt;</button>
                	<%}else { %>
                		<button onclick="location.href='<%=request.getContextPath()%>/notice.ad?selected=공지&currentPage=<%=currentPage-1%>';">&lt;</button>
                	<%} %>
                	...
                	<%}else { %>
                		<button onclick="location.href='<%=request.getContextPath()%>/notice.ad?selected=공지&currentPage=<%=p%>';"><%=p %></button>
                	<%} %>
                	<%} %>
                	...
                	<%if(currentPage == maxPage) { %>
                		<button disabled>&gt;</button>
                	<%}else { %>
                		<button onclick="location.href='<%=request.getContextPath()%>/notice.ad?selected=공지&currenPage=<%=currentPage+1%>';">&gt;</button>
                	<%} %>
                	<button onclick="location.href='<%=request.getContextPath() %>/notice.ad?selected=공지&currentPage=<%=maxPage %>';">&gt;&gt;</button>
                </div>
            </div>
        </div>    
    </div>
