    ...
    <div class = "updatePwd">
		...
		<table>
			<tr>
				<td>변경할 비밀번호</td>
					<td></td>
				<td><input type="password" class = "findpw"name="newPwd" id="newPwd" style="width:200px;"></td>
			</tr>
			<tr>
				<td>변경할 비밀번호 확인</td>
					<td></td>
				<td><input type="password" class = "findpw" name="newPwd2" id="newPwd2" style="width:200px;"></td>
			</tr>
		</table>
