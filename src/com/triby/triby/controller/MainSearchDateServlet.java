...
/**
 * Servlet implementation class MainSearchDateServlet
 */
@WebServlet("/searchDate.ma")
public class MainSearchDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainSearchDateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 검색어 결과 갯수 저장 리스트
		int sd = new MainService().searchListCount(search);
		...
		maxPage = (int)Math.ceil((double)sd / boardLimit);
		...
		PageInfo pi = new PageInfo(sd, currentPage, pageLimit, boardLimit, maxPage, startPage, endPage);
		
		ArrayList<ThumbnailTriby> slist = new MainService().searchDateList(search, pi);
