...
/**
 * Servlet implementation class UpdateTribyServlet
 */
@WebServlet("/update.tr")
public class UpdateTribyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateTribyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			int tNo = Integer.parseInt(multiRequest.getParameter("tNo"));
			...
			int result = new TribyService().updateTriby(tr, list);
