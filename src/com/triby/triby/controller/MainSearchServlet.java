...
public class MainSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 검색어 결과 갯수 저장 리스트
		int sc = new MainService().searchListCount(search);
		...
		maxPage = (int)Math.ceil((double)sc / boardLimit);
		...
		PageInfo pi = new PageInfo(sc, currentPage, pageLimit, boardLimit, maxPage, startPage, endPage);
		
		ArrayList<ThumbnailTriby> slist = new MainService().searchList(search, pi);
