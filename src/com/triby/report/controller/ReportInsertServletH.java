...
/**
 * Servlet implementation class ReportInsertServletH
 */
@WebServlet("/insertbyh.rep")
public class ReportInsertServletH extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportInsertServletH() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new ReportService().insertReport(re, 0);
